...
export declare const INVALID_APP_DATA = "Validation error: Invalid data format.";
export declare const MISSING_FIELDS = "Validation error: Missing app field.";
//# sourceMappingURL=portaRequestCreatePropertyPanelTypes.d.ts.map